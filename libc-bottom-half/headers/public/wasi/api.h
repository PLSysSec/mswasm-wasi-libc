...
_Static_assert(_Alignof(void*) == 16, "non-mswasm-wasi data layout");
...
_Static_assert(sizeof(__wasi_iovec_t) == 32, "witx calculated size");
_Static_assert(_Alignof(__wasi_iovec_t) == 16, "witx calculated align");
_Static_assert(offsetof(__wasi_iovec_t, buf) == 0, "witx calculated offset");
_Static_assert(offsetof(__wasi_iovec_t, buf_len) == 16, "witx calculated offset");
...
_Static_assert(sizeof(__wasi_ciovec_t) == 32, "witx calculated size");
_Static_assert(_Alignof(__wasi_ciovec_t) == 16, "witx calculated align");
_Static_assert(offsetof(__wasi_ciovec_t, buf) == 0, "witx calculated offset");
_Static_assert(offsetof(__wasi_ciovec_t, buf_len) == 16, "witx calculated offset");
...
_Static_assert(sizeof(__wasi_userdata_t) == 16, "witx calculated size");
_Static_assert(_Alignof(__wasi_userdata_t) == 16, "witx calculated align");
...
_Static_assert(sizeof(__wasi_event_t) == 48, "witx calculated size");
_Static_assert(_Alignof(__wasi_event_t) == 16, "witx calculated align");
_Static_assert(offsetof(__wasi_event_t, userdata) == 0, "witx calculated offset");
_Static_assert(offsetof(__wasi_event_t, error) == 16, "witx calculated offset");
_Static_assert(offsetof(__wasi_event_t, type) == 18, "witx calculated offset");
_Static_assert(offsetof(__wasi_event_t, fd_readwrite) == 24, "witx calculated offset");
...
_Static_assert(sizeof(__wasi_subscription_t) == 64, "witx calculated size");
_Static_assert(_Alignof(__wasi_subscription_t) == 16, "witx calculated align");
